...
namespace BlackBox.Tools
{
    ...
    public class WebPageUnityLoader : MonoBehaviour
    {
        ...
        //[Tooltip("The text that has been loaded")]
        //[SerializeField]
        //private MovieTexture _videoLoaded ;

        //public MovieTexture MovieLoaded
        //{
        //    get { return _videoLoaded; }
        //    private set { _videoLoaded = value; }
        //}
        ...
        [Tooltip("The texture that has been loaded")]
        [SerializeField]
        private Texture _textureLoaded = null;

        public Texture ImageLoad
        {
            get { return _textureLoaded; }
            private set { _textureLoaded = value; }
        }
        [Tooltip("The byte that has been loaded")]
        [SerializeField]
        private byte[] _byteLoaded = null;

        public byte[] ByteLoaded
        {
            get { return _byteLoaded; }
            private set { _byteLoaded = value; }
        }
    ...
    public class WebResourceUnityLoader : WebPageUnityLoader {
